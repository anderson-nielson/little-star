...
export function telaDespedida(): Tela {
  ...
  const convite = ({ piano: 'convite_piano', caderno: 'convite_letra', palavras: 'convite_letra', areia: 'convite_areia', pinhas: 'convite_pinha', jardim: 'convite_brincar', familia: 'convite_regar' } as const)[brinc];
  const pictograma = ({ piano: 'piano', caderno: 'letra', palavras: 'letra', areia: 'areia', pinhas: 'pinha', jardim: 'fora', familia: 'regador' } as const)[brinc];
