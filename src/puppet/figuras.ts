...
const F: Record<string, string> = {
  ...
  avo: `<circle cx="50" cy="30" r="15" fill="${PELE}"/><path d="M34 26q16 -20 32 0v6h-32z" fill="#d9d0c0"/><circle cx="50" cy="12" r="7" fill="#d9d0c0"/><circle cx="43" cy="30" r="5" fill="none" stroke="${C.tinta}" stroke-width="1.5" opacity="0.6"/><circle cx="57" cy="30" r="5" fill="none" stroke="${C.tinta}" stroke-width="1.5" opacity="0.6"/><path d="M48 30h4" stroke="${C.tinta}" stroke-width="1.5" opacity="0.6"/><path d="M36 46h28l10 42H26z" fill="${ROX}" opacity="0.8"/><path d="M40 60h20" stroke="${C.papel}" stroke-width="3" opacity="0.7"/>`,
  luva: `<path d="M32 92V44a7 7 0 0 1 14 0v14l4 -30a6 6 0 0 1 12 0v30l6 -26a6 6 0 0 1 12 0l-2 34l8 -14a5 5 0 0 1 9 4l-10 36z" fill="${C.rosaDoce}"/><path d="M30 92h50v-8H30z" fill="${C.veludo}"/>`,
  vaca: `<ellipse cx="52" cy="56" rx="30" ry="20" fill="${C.papel}" stroke="${CINZA}" stroke-width="2"/><circle cx="60" cy="52" r="8" fill="${C.tinta}" opacity="0.6"/><circle cx="40" cy="62" r="6" fill="${C.tinta}" opacity="0.6"/><circle cx="20" cy="46" r="13" fill="${C.papel}" stroke="${CINZA}" stroke-width="2"/><ellipse cx="16" cy="52" rx="8" ry="5" fill="${C.rosaDoce}"/><path d="M12 36l-4 -8M26 34l4 -8" stroke="${CINZA}" stroke-width="3" stroke-linecap="round"/><rect x="34" y="70" width="7" height="18" fill="${CINZA}"/><rect x="62" y="70" width="7" height="18" fill="${CINZA}"/>`,
  vela: `<rect x="38" y="36" width="24" height="52" rx="4" fill="${C.papel}" stroke="${C.ouro}"/><path d="M50 12q10 12 0 22q-10 -10 0 -22z" fill="${LAR}"/><path d="M50 20q4 6 0 12q-4 -6 0 -12z" fill="${AMA}"/><rect x="30" y="86" width="40" height="6" rx="3" fill="${C.ouro}"/>`,
  vaso: `<path d="M30 40h40l-6 48H36z" fill="${MAR}"/><rect x="26" y="34" width="48" height="8" rx="3" fill="#a8845f"/><path d="M50 34v-14" stroke="${VER}" stroke-width="4"/><circle cx="50" cy="16" r="9" fill="${C.rosaDoce}"/><circle cx="50" cy="16" r="3" fill="${AMA}"/><path d="M50 26q-12 -2 -14 -12q10 0 14 12z" fill="${VERC}"/>`,
